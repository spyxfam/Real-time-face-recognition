...
from face_recognitation import Face_Recognisation
from developer import Developer
from help import Help

class Face_recognition_sysytem:
    def __init__(self,root):
        ...
        #first image
        img1=Image.open(r"C:\Users\User\Pictures\Camera Roll\_110246786_facialrecognition3.gif")
        ...
        #second image
        img2=Image.open(r"C:\Users\User\Pictures\Camera Roll\download.jfif")
        ...
        #3rd image
        img3=Image.open(r"C:\Users\User\Pictures\Camera Roll\facial-recognition.jpg")
        ...
        title_lbl=Label(bg_img,text="FACE RECOGNITION ATTENDENCE SYSYTEM SOFTWARE",font=("times new roman",35,"bold"),bg="white",fg="red")
        title_lbl.place(x=0,y=0,width=1500,height=45)

        #student detail

        img5=Image.open(r"C:\Users\User\Pictures\Camera Roll\images.jfif")
        ...
        #face detector
        img6=Image.open(r"C:\Users\User\Pictures\Camera Roll\download (3).jfif")
        ...
        b1_1=Button(bg_img,text="Face Recogniser",cursor="hand2",command=self.face_data,font=("times new roman",15,"bold"),bg="darkblue",fg="white")
        b1_1.place(x=500,y=300,width=220,height=40)

        #attendence
        
        img7=Image.open(r"C:\Users\User\Pictures\Camera Roll\download (4).jfif")
        ...
        #help disk
        img8=Image.open(r"C:\Users\User\Pictures\Camera Roll\images (1).jfif")
        ...
        #training face
        img9=Image.open(r"C:\Users\User\Pictures\Camera Roll\How-To-Build-Facial-Recognition-Software.jpg")
        ...
        #photo stored 
        img10=Image.open(r"C:\Users\User\Pictures\Camera Roll\download (5).jfif")
        ...
        #developers
        img11=Image.open(r"C:\Users\User\Pictures\Camera Roll\download (6).jfif")
        ...
        #exit
        img12=Image.open(r"C:\Users\User\Pictures\Camera Roll\download (7).jfif")
...
if __name__=="__main__":
    root=Tk()
    obj=Face_recognition_sysytem(root)
    root.mainloop()